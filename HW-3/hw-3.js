...
for (var hash = "#"; hash.length <= 10; hash += "#"){
  console.log(hash);
}
...
for (var soda = 1; soda <= 100; soda += 1) {
  var result = "";
if (soda % 3 == 0) result += "Fizz";
  	if (soda % 5 == 0) result += "Buzz";
      console.log(result || soda)
    }
